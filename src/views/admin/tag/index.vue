  ...
  <div>
    <div>
      <el-form :inline="true" :model="queryForm" class="demo-form-inline">
        <el-form-item >
          <el-input v-model="queryForm.tagName" placeholder="标签名称"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog title="标签新增" :visible.sync="addVisible" v-if="addVisible" :center="true">
      <add @after="show" @hideDialog="close"></add>
    </el-dialog>
    <el-dialog title="编辑标签" :visible.sync="editVisible" v-if="editVisible" :center="true">
...
import add from "@/views/admin/tag/add";
import edit from "@/views/admin/tag/edit";
import Edit from "@/views/admin/tag/edit";
import Add from "@/views/admin/tag/add";
