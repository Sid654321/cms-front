...
import {detail,update,upload} from "@/api/article";
  ...
  methods:{
    ...
    getDetail(){
      ...
      detail(id).then(data=>{
        ...
        if(this.form.commentStatus != 1){
          this.form.commentStatus= true
        }else {
          this.form.commentStatus= false
        }
        if(this.form.rotation == 1){
          this.form.rotation= true
        }else {
          this.form.rotation= false
        }
        if(this.form.top == 1){
          this.form.top= true
        }else {
